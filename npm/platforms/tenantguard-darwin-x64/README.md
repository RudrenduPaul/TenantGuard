# tenantguard-darwin-x64

This package contains the prebuilt TenantGuard binary for Intel macOS (darwin/x64).
...
npm resolves this package automatically as an optional dependency when you are on Intel macOS, so the right binary lands on your `PATH` without any extra steps.
