# tenantguard-linux-x64

This package contains the prebuilt TenantGuard binary for Linux on x64.
...
npm resolves this package automatically as an optional dependency when you are on Linux x64, so the right binary lands on your `PATH` without any extra steps.
